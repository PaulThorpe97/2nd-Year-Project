<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd.master" AutoEventWireup="true" CodeFile="OrderLineHistory.aspx.cs" Inherits="OrderLineHistory" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnOrderLineIDDelete" runat="server" Text="Delete" Width="110px" />
    </p>
    <p>
        &nbsp;</p>
</asp:Content>
