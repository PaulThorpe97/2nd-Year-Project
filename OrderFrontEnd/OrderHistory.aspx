<%@ Page Title="" Language="C#" MasterPageFile="~/FrontEnd.master" AutoEventWireup="true" CodeFile="OrderHistory.aspx.cs" Inherits="OrderHistory" %>
...
&nbsp;&nbsp;&nbsp;&nbsp;
    <asp:Button ID="btnOrderIDDelete" runat="server"  Text="Delete" Width="110px"/>
&nbsp;&nbsp;&nbsp;&nbsp;
